CREATE OR REPLACE PACKAGE PAQUETE_TRABAJADOR2 IS
  ...
  PROCEDURE visualizar_lista_tipoTrabaj(pCategoria TRABAJADORES.CATEGORIA%TYPE, un_cursor OUT TRABAJADOR_CURSOR);
  PROCEDURE visualizar_datos_trabajador(pDni IN TRABAJADORES.DNI%TYPE, un_cursor OUT TRABAJADOR_CURSOR);
  PROCEDURE buscar_trabajador(pDni IN TRABAJADORES.DNI%TYPE, un_cursor OUT TRABAJADOR_CURSOR);
